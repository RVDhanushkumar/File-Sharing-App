...
def refresh_files_list():
    ...
    with FTP() as ftp:
        try:
            ...
            status_label.config(text=f"Failed to refresh file list: {e}")
...
# Server
welcome_label = Label(root, text="Welcome to File sharing app",font=10,fg="Blue")
welcome_label.pack(pady=5)
warning_label = Label(root, text="Enter the Server IP and port properly")
